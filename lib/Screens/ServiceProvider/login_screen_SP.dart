...
import 'forgot_password_screen_SP.dart';
import 'home_page_screenSP.dart';

class LoginScreenSP extends StatefulWidget {
  static String id = 'Login Screen Service Provider';
  @override
  _LoginScreenSPState createState() => _LoginScreenSPState();
}

class _LoginScreenSPState extends State<LoginScreenSP> {
  bool passwordBool;
  @override
  void initState() {
    passwordBool = true;
            ...
            children: [
              ...
              Column(
                children: [
                  ...
                  TextButton(
                    onPressed: () {
                      Navigator.pushNamed(context, ForgotPasswordScreenSP.id);
                    },
                    child: Text(
                      'Forgot Password?',
                      style: TextStyle(
